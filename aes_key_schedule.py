...
#This version by Eyal Ronen adds support for odd input round - 2019.
...
def keyScheduleRounds(inputkey, inputround, desiredround):
    ...
    if n == 16:
        ...
        if inputround % 2 == 1:
            if inputround <= desiredfull:
                raise ValueError("odd input round only permissible for reverse")
        else:
    ...
    while rnd > desiredround:
        ...
        if n == 32 and rnd % 2 == 1:
            ...
            state[0:4] = xor(oldstate[0:4], g_func(state[(n - 4):n], rcon[inputrnd+1]))
